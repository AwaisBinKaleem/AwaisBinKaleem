...
Node.JS, Express.js, Adonis.js, Hono, knex.js, TypeORM, Sequalize ORM, Drizzle ORM, Prisma ORM, SQL, Mongo DB, ConvexDB, AppWrite-DB, Sequalize ORM, Yup Schema Validation, nodemailer, Stripe Payment Gateway, Redis, Algolia, Twillio, passport js, Multer JS, AWS Serverless Lambda, Cloudflare DNS, customgpt.ai, OLLAMA, Mem0-open-memory for LLM, contimue.dev, MCP server, open MCP client, Postgres, Geospatial Information System (postGIS), Google Maps API & MapBox, iplocate.io, Swagger API Docs, log.io, n8n, Claude Code CLI, Prometheus, Grafana, HLS with imagekit.io, getStream.io, webRTC, code-review-graph, OpenClaw, Ollama & AWS etc.
