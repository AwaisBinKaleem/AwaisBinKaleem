...
- 👀 Senior Software Engineer | Full Stack JS | Node.js | React.js | Next.js | JavaScript | ReactNative | TypeScript | TypeORM | SequalizeORM | SQL | MongoDB | REST-APIs | GraphQL | AWS | web3.js | MCP
