...
**LinkedIn:** https://www.linkedin.com/in/awaisbinkaleem  
**GitHub:** https://www.github.com/AwaisBinKaleem  
...
* Setting up testnet servers using Hardhat (EVM node), Node.js, and AWS-EC2.
* Impersonating wallets for local testnets using Hardhat scripts.
* Setting up private EVM Blockchain explorers using Blockscout.
